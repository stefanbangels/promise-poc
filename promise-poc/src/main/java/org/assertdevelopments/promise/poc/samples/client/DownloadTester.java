...
public final class DownloadTester {
    ...
    private static final String URI = "/ws/download";

    private static Logger logger = Logger.getLogger(DownloadTester.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // execute request
            StreamResponse response = client.sendRequest(Constants.BASE_URL + URI);
            try {
